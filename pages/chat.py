...
def QueryBuilding():
    ...
    Query_template = """Consider yourself as a personalized professional financial assistant and coacher, Provide results for the user {query},
